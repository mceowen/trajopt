...
class SubproblemConstraints(Constraints):
    ...
    def stack_W_and_dual(self, problem, method):
        ...
        W_stack.terminal              = self._stack_constraint_attr(term_constraints, "W", (max(idx.n.term_total, 1),))
        dual_stack.terminal           = self._stack_constraint_attr(term_constraints, "dual", (max(idx.n.term_total, 1),))

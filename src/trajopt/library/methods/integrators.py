...
def jit_rk4_jax_dense(problem, method, params):
...
def propagate_rk4_dense(z0, nu_ref, t_ref, t_nl, problem, method):
...
def nonlinear_propagation(t_opt, z_opt, nu_opt, problem, method):
    ...
    if use_jax:
        ...
        z_nl = propagate_rk4_dense(z_opt[0, :n], nu_opt, t_opt, t_nl, problem, method)
    else:
        # use scipy solve_ivp

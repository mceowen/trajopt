...
from trajopt.core.analysis.custom_functions_dan_pdg import calc_body_vecs_scale1, calc_body_vecs_scale2
...
def preProcess(PLTS1,trajopt_obj,cases={}):
    ...
    params = trajopt_obj.problem.params
    fcns = trajopt_obj.problem.fcns
    ...
    for tag in tags:
        ...
        tag2 = tag + '_nl';
        tag3 = tag + '_init';
        func_args1 = ['t_opt','z_opt','nu_opt',params];
        func_args2 = ['t_nl','z_nl','nu_nl',params];
        func_args3 = ['t_init','z_init','nu_init',params];

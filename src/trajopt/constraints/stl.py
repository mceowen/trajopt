...
def smooth_inequality(y: ArrayLike, c: float = 1e-2) -> Array:
    """
...
def smooth_equality(y: ArrayLike, c: float = 1e-2) -> Array:
    """
...
def AND(y: ArrayLike, c: float = 1e-2) -> Array:
    """
...
def OR(y: ArrayLike, c: float = 1e-2) -> Array:
    """
...
def IfThen(y: ArrayLike, c: float = 1e-2) -> Array:
    """
...
def integer_variable(y: ArrayLike, values: ArrayLike, c: float = 1e-2) -> Array:
    """
...
def AND_lite(y: ArrayLike, c: float = 1e-2) -> Array:
    """
...
def OR_lite(y: ArrayLike, c: float = 1e-2) -> Array:
    """
...
def IfThen_lite(y: ArrayLike, c: float = 1e-2) -> Array:
    """

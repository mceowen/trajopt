...
import numpy as np
from trajopt.methods.dev.sqp.scp_costs.scp_cost import SCPCost
...
class scp_nonconvex_running(SCPCost):
    ...
    def merit_cost(self, scp_segment):
        return trust_region.merit_cost_scp_nonconvex_running(self, scp_segment)
...
class scp_nonconvex_terminal(SCPCost):
    ...
    def accumulate_hessian(self, scp_segment, H):
        return trust_region.accumulate_hessian_nonconvex_terminal_cost(self, scp_segment, H, _first_nonconvex_terminal_cost)

    def merit_cost(self, scp_segment):
        return trust_region.merit_cost_scp_nonconvex_terminal(self, scp_segment)
...
class scp_nonconvex_minimax(SCPCost):
    ...
    def merit_cost(self, scp_segment):
        return trust_region.merit_cost_scp_nonconvex_minimax(self, scp_segment)
...
class scp_min_time(SCPCost):
    ...
    def merit_cost(self, scp_segment):
        return trust_region.merit_cost_scp_min_time(self, scp_segment)
...
class scp_final_state(SCPCost):
    ...
    def merit_cost(self, scp_segment):
        return trust_region.merit_cost_scp_final_state(self, scp_segment)
...
class scp_final_control(SCPCost):
    ...
    def merit_cost(self, scp_segment):
        return trust_region.merit_cost_scp_final_control(self, scp_segment)
...
class scp_regularization(SCPCost):
    ...
    def merit_cost(self, scp_segment):
        return trust_region.merit_cost_scp_regularization(self, scp_segment)
...
class scp_rate_regularization(SCPCost):
    ...
    def merit_cost(self, scp_segment):
        return trust_region.merit_cost_scp_rate_regularization(self, scp_segment)

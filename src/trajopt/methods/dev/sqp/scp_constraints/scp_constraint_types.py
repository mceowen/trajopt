...
from trajopt.methods.dev.sqp.scp_constraints.scp_constraint import SCPConstraint
...
class scp_dynamics(SCPConstraint):
    ...
    def accumulate_hessian(self, scp_segment, H):
        return trust_region.accumulate_hessian_dynamics(self, scp_segment, H)
    ...
    def compile_merit_penalty(self, scp_segment):
        return trust_region.compile_merit_penalty_scp_dynamics(self, scp_segment)
...
class scp_final_state(SCPConstraint):
    ...
    def compile_merit_penalty(self, scp_segment):
        return trust_region.compile_merit_penalty_scp_final_state(self, scp_segment)
...
class scp_final_control(SCPConstraint):
    ...
    def compile_merit_penalty(self, scp_segment):
        return trust_region.compile_merit_penalty_scp_final_control(self, scp_segment)
...
class scp_nonconvex_inequality(SCPConstraint):
    ...
    def accumulate_hessian(self, scp_segment, H):
        return trust_region.accumulate_hessian_nonconvex(self, scp_segment, H, 'cp_ineq_constraints')

    def compile_merit_penalty(self, scp_segment):
        return trust_region.compile_merit_penalty_scp_nonconvex_inequality(self, scp_segment)
...
class scp_nonconvex_equality(SCPConstraint):
    ...
    def accumulate_hessian(self, scp_segment, H):
        return trust_region.accumulate_hessian_nonconvex(self, scp_segment, H, 'cp_eq_constraints')

    def compile_merit_penalty(self, scp_segment):
        return trust_region.compile_merit_penalty_scp_nonconvex_equality(self, scp_segment)
...
class scp_full_continuity(SCPConstraint):
    ...
    def build_cross_segment(self, scp_segments):
        ...
        if self.penalty_state.vb_var is not None:
            seg.cp_constraints.append(residual - self.penalty_state.vb_var[0, :] == 0)

...
class SCPSegment():
    ...
    def initialize(self) -> None:
        ...
        trust_region.compile_merit(self)
    ...
    def create_cvxpy_cost(self) -> None:
        ...
        trust_region.create_cost_trust_region(self)
    ...
    def update_cvxpy_parameters(self) -> None:
        ...
        trust_region.update_lagrangian_hessian(self)
    ...
    def apply_step(self, alpha: float) -> None:
        ...
        self.current_iter_data.cost         = sum(trust_region.evaluate_merit_cost(c, z_jnp, nu_jnp, self.params) for c in self.costs.values())
        self.current_iter_data.penalty_cost = sum(trust_region.evaluate_merit(c, z_jnp, nu_jnp, self.params) for c in self.constraints.values())
